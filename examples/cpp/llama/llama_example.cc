...
void llama_example(const INIReader reader)
{
    ...
    read_word_list("/infperf/FasterTransformer/examples/cpp/llama/bad_words.csv", bad_words);
    ...
    read_word_list("/infperf/FasterTransformer/examples/cpp/llama/stop_words.csv", stop_words);
    ...
    read_start_ids(request_batch_size,
                   ...
                   end_id,
                   1,
                   "/home/neeva/FasterTransformer/examples/cpp/llama/start_ids.csv");
    ...
    std::unordered_map<std::string, Tensor> input_tensors = std::unordered_map<std::string, Tensor>{
        ...
        {"start_id", Tensor{MEMORY_CPU, TYPE_INT32, std::vector<size_t>{1}, start_ids.data()}},
        {"end_id", Tensor{MEMORY_CPU, TYPE_INT32, std::vector<size_t>{2}, end_ids.data()}}};
